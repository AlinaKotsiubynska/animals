...
document.querySelector(".js-create-buttons").addEventListener("click", (e)=>{
    ...
    let animal = {};
    if (e.target.dataset.animal === "hare") animal = new Hare("hare");
    else animal = new Wolf("wolf");
    Animal.create.call(animal, ".js-animals-container");
});

},{"./js/Hare":"jXhNo","./js/Wolf":"1cb2u","./js/Animal":"5sbpV"}],"jXhNo":[function(require,module,exports) {
"use strict";
...
},{"./Animal":"5sbpV","../assets/hare.jpg":"YHIAG"}],"5sbpV":[function(require,module,exports) {
"use strict";
...
},{"./templates/card":"6g5P6","./utils":"72Dku"}],"6g5P6":[function(require,module,exports) {
...
},{"./image":"ikJS7","../utils":"72Dku","../constants.js":"itKcQ"}],"ikJS7":[function(require,module,exports) {
...
},{"./templates/button":"7TIwu"}],"7TIwu":[function(require,module,exports) {
...
},{}],"YHIAG":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "hare.a83b51f4.jpg" + "?" + Date.now();
...
},{}],"1cb2u":[function(require,module,exports) {
"use strict";
var Animal = require("./Animal");
...
},{"./Animal":"5sbpV","../assets/wolf.jpg":"7AQvk"}],"7AQvk":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "wolf.78cc1937.jpg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequire9973")
